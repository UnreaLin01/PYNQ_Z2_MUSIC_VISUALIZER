...
#
# vu_fft.tcl: Tcl script for re-creating project 'vu_fft'
#
# Generated by Vivado on Sat Aug 09 22:02:22 +0800 2025
...
#
# 1. This project restoration tcl script (vu_fft.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/User/Desktop/Desktop/Education/113-2/Advanced_FPGA_Design/projects/vu_final/vu_fft/vu_fft.srcs/sources_1/new/neo_pixel.vhd"
#    "C:/Users/User/Desktop/Desktop/Education/113-2/Advanced_FPGA_Design/projects/vu_final/vu_fft/vu_fft.srcs/constrs_1/new/Pin.xdc"
#    "C:/Users/User/Desktop/Desktop/Education/113-2/Advanced_FPGA_Design/projects/vu_final/vu_fft/vu_fft.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "sources/neo_pixel.vhd"]"\
 "[file normalize "constraints/Pin.xdc"]"\
...
set orig_proj_dir "[file normalize "$origin_dir/../Desktop/Education/113-2/Advanced_FPGA_Design/projects/vu_final/vu_fft"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../AppData/Roaming/Xilinx/Vivado/2024.2.1/xhub/board_store/xilinx_board_store"]" -objects $obj
...
set file "sources/neo_pixel.vhd"
...
set file "[file normalize "constraints/Pin.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constraints/Pin.xdc"
...
set_property -name "target_constrs_file" -value "[get_files [list "*constraints/Pin.xdc"]]" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*constraints/Pin.xdc"]]" -objects $obj
...
set file "utils/design_1_wrapper.dcp"
...
if { [get_files [list neo_pixel.vhd]] == "" } {
  import_files -quiet -fileset sources_1 sources/neo_pixel.vhd
}
...
# neo_pixel
  ...
  # Create ports
  set RGBLED_DOUT [ create_bd_port -dir O RGBLED_DOUT ]
  set CLK_IND [ create_bd_port -dir O -from 0 -to 0 CLK_IND ]
...
\
  ...
  # Create instance: neo_pixel_0, and set properties
  set block_name neo_pixel
  set block_cell_name neo_pixel_0
  if { [catch {set neo_pixel_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $neo_pixel_0 eq "" } {
  ...
  # Create instance: rst_ps7_1_20M, and set properties
  set rst_ps7_1_20M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_1_20M ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins xfft_0/S_AXIS_DATA] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins smartconnect_0/S01_AXI] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net btns_GPIO [get_bd_intf_ports btns_4bits] [get_bd_intf_pins btns/GPIO]
  ...
  connect_bd_intf_net -intf_net floating_point_1_M_AXIS_RESULT [get_bd_intf_pins floating_point_1/M_AXIS_RESULT] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP1 [get_bd_intf_pins smartconnect_2/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP1]
  ...
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net smartconnect_2_M01_AXI [get_bd_intf_pins leds/S_AXI] [get_bd_intf_pins smartconnect_2/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M02_AXI [get_bd_intf_pins btns/S_AXI] [get_bd_intf_pins smartconnect_2/M02_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M03_AXI [get_bd_intf_pins sws/S_AXI] [get_bd_intf_pins smartconnect_2/M03_AXI]
  connect_bd_intf_net -intf_net sws_GPIO [get_bd_intf_ports sws_2bits] [get_bd_intf_pins sws/GPIO]

  # Create port connections
  connect_bd_net -net blk_mem_gen_0_doutb  [get_bd_pins blk_mem_gen_0/doutb] \
  [get_bd_pins neo_pixel_0/doutb]
  connect_bd_net -net c_addsub_0_S  [get_bd_pins c_addsub_0/S] \
  [get_bd_pins floating_point_0/s_axis_a_tdata]
  connect_bd_net -net c_counter_binary_0_Q  [get_bd_pins c_counter_binary_0/Q] \
  [get_bd_pins xlslice_2/Din]
  connect_bd_net -net floating_point_0_s_axis_a_tready  [get_bd_pins floating_point_0/s_axis_a_tready] \
  [get_bd_pins xfft_0/m_axis_data_tready]
  connect_bd_net -net mult_gen_0_P  [get_bd_pins mult_gen_0/P] \
  [get_bd_pins c_addsub_0/A]
  connect_bd_net -net mult_gen_1_P  [get_bd_pins mult_gen_1/P] \
  [get_bd_pins c_addsub_0/B]
  connect_bd_net -net neo_pixel_0_addrb  [get_bd_pins neo_pixel_0/addrb] \
  [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net neo_pixel_0_dinb  [get_bd_pins neo_pixel_0/dinb] \
  [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net neo_pixel_0_dout  [get_bd_pins neo_pixel_0/dout] \
  [get_bd_ports RGBLED_DOUT]
  connect_bd_net -net neo_pixel_0_enb  [get_bd_pins neo_pixel_0/enb] \
  [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net neo_pixel_0_rstb  [get_bd_pins neo_pixel_0/rstb] \
  [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net neo_pixel_0_web  [get_bd_pins neo_pixel_0/web] \
  ...
  [get_bd_pins floating_point_0/aclk] \
  [get_bd_pins floating_point_1/aclk] \
  ...
  [get_bd_pins neo_pixel_0/clk] \
  [get_bd_pins blk_mem_gen_0/clkb] \
  [get_bd_pins rst_ps7_1_20M/slowest_sync_clk] \
  [get_bd_pins btns/s_axi_aclk] \
  ...
  [get_bd_pins rst_ps7_1_20M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_1_20M_interconnect_aresetn  [get_bd_pins rst_ps7_1_20M/interconnect_aresetn] \
  [get_bd_pins smartconnect_2/aresetn]
  connect_bd_net -net rst_ps7_1_20M_peripheral_aresetn  [get_bd_pins rst_ps7_1_20M/peripheral_aresetn] \
  [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] \
  [get_bd_pins btns/s_axi_aresetn] \
  [get_bd_pins sws/s_axi_aresetn] \
  [get_bd_pins leds/s_axi_aresetn]
  connect_bd_net -net util_reduced_logic_0_Res  [get_bd_pins util_reduced_logic_0/Res] \
  [get_bd_ports CLK_IND]
  connect_bd_net -net util_vector_logic_0_Res  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins xfft_0/s_axis_config_tvalid]
  connect_bd_net -net xfft_0_m_axis_data_tdata  [get_bd_pins xfft_0/m_axis_data_tdata] \
  [get_bd_pins xlslice_0/Din] \
  [get_bd_pins xlslice_1/Din]
  connect_bd_net -net xfft_0_m_axis_data_tlast  [get_bd_pins xfft_0/m_axis_data_tlast] \
  [get_bd_pins floating_point_0/s_axis_a_tlast]
  connect_bd_net -net xfft_0_m_axis_data_tvalid  [get_bd_pins xfft_0/m_axis_data_tvalid] \
  [get_bd_pins floating_point_0/s_axis_a_tvalid]
  ...
  [get_bd_pins mult_gen_1/A] \
  [get_bd_pins mult_gen_1/B]
  ...
  assign_bd_address -offset 0x81200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btns/S_AXI/Reg] -force
  assign_bd_address -offset 0x81210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs leds/S_AXI/Reg] -force
  assign_bd_address -offset 0x81220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sws/S_AXI/Reg] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Desktop/Education/113-2/Advanced_FPGA_Design/projects/vu_final/vu_fft/vu_fft.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "utils/design_1_wrapper.dcp" -objects $obj
